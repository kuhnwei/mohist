...
public class RenameFileCommand extends XMLCommand implements IPostCommand {
	...
	protected int getDataForXml() {
		...
		try {
			...
			if (this.renamed) {
				renameThumb();
				String pathName = configuration.getTypes().get(this.type).getUrl() + this.currentFolder;
				String oldPath = pathName + this.fileName;
				String newPath = pathName + this.newFileName;
				// TODO 文件重命名
//				CkfinderFtpClient.rename(oldPath, newPath);
