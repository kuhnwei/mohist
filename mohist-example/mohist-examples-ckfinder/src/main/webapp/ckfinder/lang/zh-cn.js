...
CKFinder.lang['zh-cn'] =
{
	...
	FolderDeleting	: ' (正在删除...)',
	DestinationFolder	: '目标文件夹', // MISSING DestinationFolder	: 'Destination Folder',
	...
	FilesDelete	    : '您确定要删除这些文件 %1 吗?', // MISSING  FilesDelete	: 'Are you sure you want to delete %1 files?',
	FilesLoading	: '加载中...',
	FilesEmpty		: '空文件夹',
	DestinationFile	: '目标文件', // MISSING DestinationFile	: 'Destination File',
	SkippedFiles	: 'List of skipped files:', // MISSING SkippedFiles	: 'List of skipped files:',
	...
	// Global messages
	OperationCompletedSuccess	: '操作成功。', // MISSING OperationCompletedSuccess	: 'Operation completed successfully.', // MISSING
	OperationCompletedErrors		: '操作错误。', // MISSING OperationCompletedErrors		: 'Operation completed with errors.', // MISSING
	FileError				: '%s: %e', // MISSING

	// Move and Copy files
	MovedFilesNumber		: '被移动的文件数量: %s.', // MISSING MovedFilesNumber		: 'Number of files moved: %s.', // MISSING
	CopiedFilesNumber	: '被复制的文件数量: %s.', // MISSING CopiedFilesNumber	: 'Number of files copied: %s.', // MISSING
	MoveFailedList		: '以下文件无法移动:<br />%s', // MISSING MoveFailedList		: 'The following files could not be moved:<br />%s', // MISSING
	CopyFailedList		: '以下文件无法复制:<br />%s', // MISSING CopyFailedList		: 'The following files could not be copied:<br />%s', // MISSING
	...
	ManuallyRename	: '手动重命名', // MISSING ManuallyRename	: 'Manually rename', // MISSING
	...
	109 : '无效请求。',
	110 : '未知错误。',
	111 : '文件内存过大，无法完成请求。', // MISSING 111 : 'It was not possible to complete the request due to resulting file size.', // MISSING
	115 : '存在重名的文件或文件夹。',
	116 : '文件夹不存在. 请刷新后再试。',
	117 : '文件不存在. 请刷新列表后再试。',
	118 : '目标位置与当前位置相同。',
	...
	ErrorMsg :
	{
		...
		FolderExists	: '文件夹 %s 已存在。', // MISSING FolderExists	: 'Folder %s already exists.', // MISSING
		FolderNameExists	: '文件夹已存在', // MISSING FolderNameExists	: 'Folder already exists.', // MISSING
