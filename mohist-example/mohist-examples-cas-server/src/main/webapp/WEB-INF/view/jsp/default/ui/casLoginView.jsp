    ...
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        ...
        <section class="row check">
            <p>
                ...
                <br/>
                <input id="publicWorkstation" name="publicWorkstation" value="false" tabindex="5" type="checkbox" />
                <label for="publicWorkstation"><spring:message code="screen.welcome.label.publicstation" /></label>
                <br/>
                <input type="checkbox" name="rememberMe" id="rememberMe" value="true" tabindex="6"  />
        ...
        <section class="row btn-row">
            ...
            <input class="btn-submit" name="submit" accesskey="l" value="<spring:message code="screen.welcome.button.login" />" tabindex="7" type="submit" />
            <input class="btn-reset" name="reset" accesskey="c" value="<spring:message code="screen.welcome.button.clear" />" tabindex="8" type="reset" />
        </section>
    </form:form>
</div>
