 ...
 */
public class ConnectionZooKeeperDemo3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (zkClient.exists(CHILDREN_NODE, false) == null) {
            String createPath = zkClient.create(CHILDREN_NODE, "HelloChildren".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
